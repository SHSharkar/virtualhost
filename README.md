...
```bash
$ cd /usr/local/bin
$ wget -O virtualhost https://github.com/SHSharkar/virtualhost/master/virtualhost.sh
$ chmod +x virtualhost
$ wget -O virtualhost-nginx https://github.com/SHSharkar/virtualhost/master/virtualhost-nginx.sh
